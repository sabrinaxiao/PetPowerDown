...
for(j = 0; j < array_length_1d(global.pets_in_current_level); j ++)
{
	...
	// doggo, bunno, cato, spr_snake, spr_hedgehog
	...
	// The dog's movement
	if(global.pets_in_current_level[j] == doggo)
	{
	...
	else if(global.pets_in_current_level[j] == bunno)
	{
	...
	// The cat's movement
	else if(global.pets_in_current_level[j] == catto)
	{
